...
/*****************************Popup类弹出窗口******************************/
var Popup = new Class();
//iframeIdName弹出窗口中框架的名称
//setContent设置配置信息和参数内容
//reBuild重新加载弹出窗口的高度和内容
//forCallback设置回调函数
//shadow为弹出窗口设置阴影
//middle让弹出窗口居中显示
//reset刷新页面，并关闭当前弹出窗口
//close关闭当前弹出窗口
//hiddenSome隐藏someHiddenTag和someHiddenEle中的所有元素
//hiddenTag隐藏一组元素
//hiddenEle隐藏单个元素
//showSome将someToHidden中保存的隐藏元素全部显示,并恢复顶部和底部的div为原来的id值
