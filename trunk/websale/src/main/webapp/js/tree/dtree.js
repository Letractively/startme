...
// Tree object
function dTree(objName,isCookies,isCount) {
    this.config = {target:null, folderLinks:true, useSelection:true, useCookies:isCookies, useLines:true, useIcons:true, useStatusText:true, closeSameLevel:false, inOrder:false,showCount:isCount};
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (node.url) {
        str += "<a hidefocus id=\"s" + this.obj + nodeId + "\" class=\"" + ((this.config.useSelection) ? ((node._is ? "nodeSel" : "node")) : "node") + "\" href=\"" + node.url + "\"";
        if (node.title) {
