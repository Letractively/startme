	...
	<body>
		...
		<form action="sampleposteddata.jsp" method="post" target="_blank">
			<FCK:editor id="EditorDefault" basePath="<%=basepath%>"
				...
				customConfigurationsPath="<%=configpath%>"
				...
				linkBrowserURL="/websale/fckeditor/editor/filsemanager/browser/default/browser.html?Connector=connectors/jsp/connector"
